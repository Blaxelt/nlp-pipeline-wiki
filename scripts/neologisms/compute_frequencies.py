...
input_path  = (script_dir / '../../data/eswiki-20251020-pages-articles-ns0-clean.json').resolve()
output_path = (script_dir / '../../data/frequency/eswiki_20251020_word_frequencies_ns0_clean.txt').resolve()
